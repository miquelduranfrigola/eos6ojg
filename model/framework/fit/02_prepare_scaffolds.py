...
file_name = os.path.join(root, "..", "..", "checkpoints", "ADB_all_found_smiles.csv")
...
scaffolds_inchikeys = []
scaffolds_smiles = []
for smi, scaffold in tqdm(zip(smiles_list, scaffolds)):
...
df.to_csv(os.path.join(root, "..", "..", "checkpoints", "adb_murcko_scaffolds.tsv"), index=False, sep="\t")
...
with open(os.path.join(root, "..", "..", "checkpoints", "adb_brics_scaffolds.tsv"), "w") as f:
